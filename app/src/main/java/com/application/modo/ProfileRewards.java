...
public class ProfileRewards extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_rewards);

        tvUsername = findViewById(R.id.tvUsername);
        imgvPicture = findViewById(R.id.imgvPicture2); // make sure this ID is correct in your XML
